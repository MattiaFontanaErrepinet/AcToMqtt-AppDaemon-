...
class Device:
    def __init__(self, host, mac, devtype, update_interval=0):
        self.host = host
        self.mac = mac
...
class AcDb(Device):
    def __init__(self, host, mac, name=None, cloud=None, devtype=0x4E2a, update_interval=0):
        super().__init__(host, mac, devtype, update_interval)
        self.name = name
        self.cloud = cloud

    def update(self):
        # Implement update logic specific to AC_DB
        pass  # Implement according to your needs


class AcDbDebug(Device):
    def __init__(self, host, mac, name=None, cloud=None, devtype=0xFFFFFFF, update_interval=0):
        super().__init__(host, mac, devtype, update_interval)
        self.name = name
        self.cloud = cloud

    def update(self):
        # Implement update logic specific to AC_DB_DEBUG
        pass  # Implement according to your needs


def gendevice(devtype, host, mac, name=None, cloud=None, update_interval=0):
    if devtype == 0x4E2a:
        return AcDb(host=host, mac=mac, name=name, cloud=cloud, devtype=devtype, update_interval=update_interval)
    elif devtype == 0xFFFFFFF:
        return AcDbDebug(host=host, mac=mac, name=name, cloud=cloud, devtype=devtype, update_interval=update_interval)
    else:
